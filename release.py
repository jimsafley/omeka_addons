...
def register(addon_id, asset_id, version, download_url, ini):
    db = addonregistry.Db()
    db.insert_release(addon_id, asset_id, version, download_url, ini)
...
if __name__ == '__main__':
    ...
    #~ register(addon_id, args.asset_id, args.version, args.download_url, args.ini)
